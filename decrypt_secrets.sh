...
FILES_TO_DECRYPT=("./zsh/private.zsh" "./git/config" "./git/config-work" "./git/config-work2" "./git/config-personal" "./avitech/config.json" "./avitech/settings.xml" "./avitech/settings-nm.xml" "./avitech/toolchains.xml")
